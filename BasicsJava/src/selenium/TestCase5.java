...
public class TestCase5 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String path = "C:\\Swetha\\JanQaReports\\TestCase5.html";
...
Thread.sleep(4000);
		...
		myProfile.click();
		WebElement userMenu1 = driver.findElement(By.id("userNav-arrow"));
		userMenu1.click();
		Thread.sleep(4000);
		WebElement mySettings = driver.findElement(By.linkText("My Settings"));
		mySettings.click();
		WebElement userMenu2 = driver.findElement(By.id("userNav-arrow"));
		userMenu2.click();
		Thread.sleep(4000);
		...
		WebElement userMenu3 = driver.findElement(By.id("userNav-arrow"));
		userMenu3.click();
		Thread.sleep(4000);
